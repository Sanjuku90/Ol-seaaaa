...
async function seedDatabase() {
  await db.update(machines).set({ minDeposit: 15 }).where(eq(machines.type, "rent"));
  ...
  if (existingMachines.length === 0) {
    await db.insert(machines).values([
      { name: "Rent Mini", type: "rent", rentalPrice: "4.99", minDeposit: 15, dailyRate: "11.90", durationDays: 30, description: "Location abordable pour débuter." },
      { name: "Rent Starter", type: "rent", rentalPrice: "14.99", minDeposit: 15, dailyRate: "12.30", durationDays: 30, description: "Idéal pour booster vos premiers gains." },
      { name: "Rent Standard", type: "rent", rentalPrice: "24.99", minDeposit: 15, dailyRate: "12.80", durationDays: 30, description: "Bon équilibre entre coût et rendement." },
      { name: "Rent Pro", type: "rent", rentalPrice: "29.99", minDeposit: 15, dailyRate: "13.30", durationDays: 30, description: "Pour les mineurs avertis." },
      { name: "Rent Elite", type: "rent", rentalPrice: "49.99", minDeposit: 15, dailyRate: "13.80", durationDays: 30, description: "Performance maximale en location." },
