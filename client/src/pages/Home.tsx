...
export default function Home() {
  ...
  const features = [
    {
      ...
      points: ["Dépôt min. 52 $", "Gains quotidiens", "Frais maintenance 3$/mois"],
      color: "text-blue-400",
      bg: "bg-blue-500/8",
  ...
  const faqs = [
    { q: "Quel est le dépôt minimum ?", a: "Pour les machines en location, le dépôt minimum est de 52 $. Pour les achats, le prix de départ est de 90 $ (après promo -50%)." },
