...
export default function Home() {
  ...
  const features = [
    {
      ...
      points: ["Dépôt min. 21 $", "Gains quotidiens", "Frais maintenance 3$/mois"],
      color: "text-blue-400",
      bg: "bg-blue-500/8",
    ...
    },
    {
      ...
      points: ["Paiement unique", "Rendement 12.8–14.3%/jour", "Machine permanente"],
  ...
  const faqs = [
    { q: "Quel est le dépôt minimum ?", a: "Pour les machines en location, le dépôt minimum est de 21 $. Pour les achats, le prix de départ est de 90 $ (après promo -50%)." },
          ...
          <div className="rounded-2xl p-7 md:p-10 relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <p className="text-center text-xs text-muted-foreground/40 mt-4">
                * Estimation basée sur un taux moyen de 12.5%/jour. Résultats non garantis.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: BarChart3, title: "Rendements compétitifs", desc: "Jusqu'à 14.3% de rendement journalier avec les machines Elite.", color: "text-violet-400", bg: "bg-violet-500/10", border: "border-violet-500/15" },
