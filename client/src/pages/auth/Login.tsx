    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            <Link href="/" className="inline-flex items-center space-x-3 mb-8 lg:hidden">
      ...
      <div className="hidden lg:flex relative bg-secondary overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg text-center">
          <div className="mb-8 inline-flex p-2 bg-primary/20 rounded-2xl backdrop-blur-xl border border-white/10 w-24 h-24 items-center justify-center">
            <img src={logoImg} alt="BlockMint Logo" className="w-full h-full object-contain" />
          </div>
